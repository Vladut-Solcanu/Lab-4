...
namespace EvidentaStudenti
{
    class Program
    {
            ...
            do
            {
                ...
                switch (optiune)
                {
                    ...
                    case "I":
                        ...
                        {
                            Console.WriteLine("Nu exista student introdus.");
                        }
                        break;
        ...
        public static Student CitireStudentTastatura()
        {
            ...
            // Afisare optiuni program de studiu pe baza enumerarii
            Console.WriteLine("Alegeti un program de studiu (valoare - denumire):");
            foreach (ProgramStudiu p in Enum.GetValues(typeof(ProgramStudiu)))
            {
                Console.WriteLine($"{(int)p} - {p}");
            }

            // Citire si validare program de studiu cu tratare exceptii
            int optProgram;
            while (true)
            {
                Console.Write("Introduceti valoarea programului de studiu: ");
                try
                {
                    ...
                    optProgram = int.Parse(input);

                    if (!Enum.IsDefined(typeof(ProgramStudiu), optProgram))
                    {
                        throw new ArgumentException("Valoare in afara domeniului enumerarii.");
                    }
                ...
                {
                    Console.WriteLine("Eroare: Trebuie sa introduceti un numar valid pentru programul de studiu.");
                }
                catch (OverflowException)
                {
                    Console.WriteLine("Eroare: Valoarea numerica introdusa este prea mare sau prea mica.");
                }
                catch (ArgumentException)
                {
                    Console.WriteLine("Eroare: Optiune invalida pentru programul de studii. Alegeti una din valorile afisate.");
                }
            }

            student.ProgramStudiu = (ProgramStudiu)optProgram;
